...
const valid = {
  ...
  pattern: {schemaVersion:'adversarial-kb-pattern-v1',patternId:'PATTERN-0001',name:'Donation-driven share-rate inflation',description:'External donation changes a balance-derived share rate.',rootCauseClass:['DONATION','SHARE_PRICE_INFLATION'],structuralPreconditions:[],runtimePreconditions:[],attackerCapabilities:[],attackSequenceAbstract:[],expectedSecurityPropertyViolation:[],sourceIntelligenceSignals:[],runtimeOverlaySignals:[],nonApplicabilitySignals:[],falsePositiveGuards:['donations excluded from accounted assets'],adaptationRules:[],recommendedBackends:['foundry','anvil'],historicalIncidentRefs:['EXP-2023-0001'],recipeRefs:['RECIPE-0001'],limitations:[]},
  recipe: {schemaVersion:'adversarial-kb-recipe-v1',recipeId:'RECIPE-0001',patternRefs:['PATTERN-0001'],targetTopologies:['ERC4626','SHARE_VAULT'],requiredTargetBindings:['asset','vault','depositFunction','withdrawFunction','shareBalanceAccessor','totalAssetsAccessor'],setupSteps:[],attackSteps:[],observations:[],assertions:[],adaptationInputs:[],backendSupport:{medusa:'SUPPORTED',foundry:'SUPPORTED',anvil:'SUPPORTED'},executableRefs:['EXEC-0001'],proofStatusRef:'PROOF-0001'},
  executable: {schemaVersion:'adversarial-kb-executable-v1',executableId:'EXEC-0001',incidentRefs:['EXP-2023-0001'],patternRefs:['PATTERN-0001'],recipeRefs:['RECIPE-0001'],backend:'foundry',toolVersion:'forge-1.3.1',language:'solidity',sourceFiles:[{path:'test/Donation.t.sol',digest:'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'}],expectedSetup:[],requiredRpcForkState:{required:false},requiredBlockIdentity:null,requiredImpersonation:[],requiredTokenBalances:[],expectedResult:{kind:'CONTROLLED_REPRODUCTION'},proofStatusRef:'PROOF-0001',lastQualification:{commit:'468b749076fb5b9c166c14a187fdd29a6f967acd',runId:'LOCAL-STATIC-NOT-EXECUTION'}},
