...
contract CyvlSdtSystemPhase6HarnessV4 {
...
contract CyvlSdtSystemPhase6FoundryV4 {
    struct FuzzSelector { address addr; bytes4[] selectors; }
    CyvlSdtSystemPhase6HarnessV4 public harness;

    function setUp() public { harness = new CyvlSdtSystemPhase6HarnessV4(); }
    ...
    function targetSelectors() public view returns (FuzzSelector[] memory selectors_) {
        ...
        selectors[0] = CyvlSdtSystemPhase6HarnessV4.actionRevenueStake.selector;
        selectors[1] = CyvlSdtSystemPhase6HarnessV4.actionRevenueWithdraw.selector;
        selectors[2] = CyvlSdtSystemPhase6HarnessV4.actionBoostDeposit.selector;
        selectors[3] = CyvlSdtSystemPhase6HarnessV4.actionBoostWithdraw.selector;
        selectors[4] = CyvlSdtSystemPhase6HarnessV4.actionVaultDeposit.selector;
        selectors[5] = CyvlSdtSystemPhase6HarnessV4.actionVaultWithdraw.selector;
        selectors[6] = CyvlSdtSystemPhase6HarnessV4.actionYieldStake.selector;
        selectors[7] = CyvlSdtSystemPhase6HarnessV4.actionYieldWithdraw.selector;
        selectors[8] = CyvlSdtSystemPhase6HarnessV4.actionNotifyReward.selector;
        selectors[9] = CyvlSdtSystemPhase6HarnessV4.actionGenerateVlSdtYield.selector;
        selectors[10] = CyvlSdtSystemPhase6HarnessV4.actionGovernanceReservation.selector;
        selectors[11] = CyvlSdtSystemPhase6HarnessV4.actionConverterRoute.selector;
        selectors[12] = CyvlSdtSystemPhase6HarnessV4.actionLockerAccounting.selector;
        selectors[13] = CyvlSdtSystemPhase6HarnessV4.actionMerchantConfig.selector;
        selectors[14] = CyvlSdtSystemPhase6HarnessV4.actionFraxFeeConfig.selector;
        selectors[15] = CyvlSdtSystemPhase6HarnessV4.actionDiscountRate.selector;
