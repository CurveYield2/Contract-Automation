...
/// @notice Versioned repair of the supplemental audit-only full-system accounting state machine.
/// V1 remains immutable failed execution evidence. V2 changes only the token/Locker configuration
/// ordering so that the real Locker is deployed before the production token is bound to it.
contract CyvlSdtSystemPhase6HarnessV2 {
...
contract CyvlSdtSystemPhase6FoundryV2 {
    struct FuzzSelector { address addr; bytes4[] selectors; }
    CyvlSdtSystemPhase6HarnessV2 public harness;

    function setUp() public { harness = new CyvlSdtSystemPhase6HarnessV2(); }
    ...
    function targetSelectors() public view returns (FuzzSelector[] memory selectors_) {
        ...
        selectors[0] = CyvlSdtSystemPhase6HarnessV2.actionRevenueStake.selector;
        selectors[1] = CyvlSdtSystemPhase6HarnessV2.actionRevenueWithdraw.selector;
        selectors[2] = CyvlSdtSystemPhase6HarnessV2.actionBoostDeposit.selector;
        selectors[3] = CyvlSdtSystemPhase6HarnessV2.actionBoostWithdraw.selector;
        selectors[4] = CyvlSdtSystemPhase6HarnessV2.actionVaultDeposit.selector;
        selectors[5] = CyvlSdtSystemPhase6HarnessV2.actionVaultWithdraw.selector;
        selectors[6] = CyvlSdtSystemPhase6HarnessV2.actionYieldStake.selector;
        selectors[7] = CyvlSdtSystemPhase6HarnessV2.actionYieldWithdraw.selector;
        selectors[8] = CyvlSdtSystemPhase6HarnessV2.actionNotifyReward.selector;
        selectors[9] = CyvlSdtSystemPhase6HarnessV2.actionGovernanceReservation.selector;
        selectors[10] = CyvlSdtSystemPhase6HarnessV2.actionConverterRoute.selector;
        selectors[11] = CyvlSdtSystemPhase6HarnessV2.actionLockerAccounting.selector;
        selectors[12] = CyvlSdtSystemPhase6HarnessV2.actionMerchantConfig.selector;
        selectors[13] = CyvlSdtSystemPhase6HarnessV2.actionFraxFeeConfig.selector;
        selectors[14] = CyvlSdtSystemPhase6HarnessV2.actionDiscountRate.selector;
