...
contract Phase6FakeSwapAdapterV5 {
    ...
    constructor(address tokenIn_, address tokenOut_, uint256 numerator_, uint256 denominator_) {
        ...
        tokenIn = tokenIn_;
        tokenOut = Phase6MintableTokenV5(tokenOut_);
...
contract CyvlSdtRevenueAccountingHarnessV5 {
    using SafeERC20 for IERC20;
    ...
    constructor() {
        ...
        fakeUsdToSdtAdapter = new Phase6FakeSwapAdapterV5(
            address(fakeYieldToken), address(fakeSdt), 1e12, 1
        );
        fakeSdtToPrincipalAdapter = new Phase6FakeSwapAdapterV5(
        ...
        directA = new Phase6RevenueActorV5(
            address(this), address(principal), address(fakeYieldToken), address(revenueStaking), address(vault), address(boostMerchant)
        );
        directB = new Phase6RevenueActorV5(
            address(this), address(principal), address(fakeYieldToken), address(revenueStaking), address(vault), address(boostMerchant)
        );
        directC = new Phase6RevenueActorV5(
            address(this), address(principal), address(fakeYieldToken), address(revenueStaking), address(vault), address(boostMerchant)
        );
        merchantBuyer = new Phase6RevenueActorV5(
            address(this), address(principal), address(fakeYieldToken), address(revenueStaking), address(vault), address(boostMerchant)
        );
    ...
    function _requireActorCall(Phase6RevenueActorV5 actor, address target, bytes memory data)
        internal
    ...
    function _actorByIndex(uint256 index) internal view returns (Phase6RevenueActorV5 actor) {
    ...
    function _claimExpected(Phase6RevenueActorV5 actor, uint256 expected) internal returns (uint256 claimed) {
    ...
    function actionRevenueStakeWhole(uint16 raw) external {
        ...
        Phase6RevenueActorV5 actor = _actorByIndex(index);
...
contract CyvlSdtRevenueAccountingFoundryV5 {
    struct FuzzSelector { address addr; bytes4[] selectors; }
    CyvlSdtRevenueAccountingHarnessV5 public harness;

    function setUp() public { harness = new CyvlSdtRevenueAccountingHarnessV5(); }
    ...
    function targetSelectors() public view returns (FuzzSelector[] memory selectors_) {
        ...
        selectors[0] = CyvlSdtRevenueAccountingHarnessV5.actionRevenueStakeWhole.selector;
        selectors[1] = CyvlSdtRevenueAccountingHarnessV5.actionRevenueWithdrawWhole.selector;
        selectors[2] = CyvlSdtRevenueAccountingHarnessV5.actionQueueWithdrawalWhole.selector;
        selectors[3] = CyvlSdtRevenueAccountingHarnessV5.actionCompleteQueuedWithdrawal.selector;
        selectors[4] = CyvlSdtRevenueAccountingHarnessV5.actionVaultDepositWhole.selector;
        selectors[5] = CyvlSdtRevenueAccountingHarnessV5.actionVaultEarn.selector;
        selectors[6] = CyvlSdtRevenueAccountingHarnessV5.actionGenerateVlSdtYieldWhole.selector;
        selectors[7] = CyvlSdtRevenueAccountingHarnessV5.actionMerchantLeaseWhole.selector;
        selectors[8] = CyvlSdtRevenueAccountingHarnessV5.actionStartRewardCycle.selector;
        selectors[9] = CyvlSdtRevenueAccountingHarnessV5.actionClaimRewards.selector;
        selectors[10] = CyvlSdtRevenueAccountingHarnessV5.actionHarvestStrategy.selector;
        selectors[11] = CyvlSdtRevenueAccountingHarnessV5.actionVaultWithdrawWhole.selector;
