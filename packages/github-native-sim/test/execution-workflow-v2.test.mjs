...
test('V7 execution workflow v3 exposes private controller auth and archive RPC only to execution steps', () => {
  assert.equal(fs.existsSync(workflowPath), true, 'restored V7 execution workflow v3 must exist');
