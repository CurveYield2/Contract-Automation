...
const workflowPath = path.join(repoRoot, '.github/workflows/audit-controller-execution-v2.yml');

test('V7 execution workflow exposes private controller auth and archive RPC only to execution steps', () => {
  assert.equal(fs.existsSync(workflowPath), true, 'restored V7 execution workflow must exist');
