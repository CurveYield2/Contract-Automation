...
const REQUIRED_ACTION_FAMILIES = [
  ...
  // Vault / strategy lifecycle and emergency states, bound to exact V30 callables.
  'actionVaultDepositWhole',
  'actionVaultDepositAll',
  'actionVaultDepositStrictWhole',
  'actionVaultEarn',
  'actionVaultWithdrawWhole',
  'actionVaultWithdrawAll',
  'actionVaultProposeStrategyControlled',
  'actionStrategyDeposit',
  'actionStrategyHarvest',
  'actionStrategyBeforeDepositStrict',
  'actionStrategyBeforeDeposit',
  'actionStrategyWithdrawWhole',
  ...
  'actionLockerModuleReserveControlled',
